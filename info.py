...
BOT_TOKEN = environ.get('BOT_TOKEN', "-xKbtXu5Q")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1978633902').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003027413387'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003077279506').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+AphCv5Gjm2EwMjVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AAAMoviez')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT','ROD_MOVIES_FAN') # Support Chat Link Without https:// or @
